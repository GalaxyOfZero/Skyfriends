...
<recipetype:ars_nouveau:enchanting_apparatus>.addRecipe("sapling4", <item:ars_nouveau:blue_archwood_sapling>, <item:minecraft:oak_sapling>, [<item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>, <item:minecraft:blue_dye>]);
