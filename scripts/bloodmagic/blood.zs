...
<recipetype:bloodmagic:soulforge>.addRecipe("dust-hellforged", <item:bloodmagic:sand_hellforged>, [<tag:items:forge:dusts/gold>, <tag:items:forge:dusts/corrupti>], 0, 100);
