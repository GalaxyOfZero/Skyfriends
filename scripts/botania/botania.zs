...
<recipetype:botania:mana_infusion>.addRecipe("dielectric_paste", <item:powah:dielectric_paste>, <tag:items:minecraft:coals>, 5000);
<recipetype:botania:terra_plate>.addRecipe("dielectric_casing", <item:powah:dielectric_casing>, 8000, <item:powah:dielectric_rod>, <item:powah:dielectric_rod>, <item:powah:dielectric_rod_horizontal>, <item:powah:dielectric_rod_horizontal>, <tag:items:forge:ingots/steel>, <tag:items:forge:ingots/steel>, <tag:items:forge:ingots/steel>, <tag:items:forge:ingots/steel>);
