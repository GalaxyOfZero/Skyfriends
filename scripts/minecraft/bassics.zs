...
craftingTable.removeByName("crafttweaker:autogenerated/improved-stations.crafting_station");
...
craftingTable.removeRecipe(<item:createdeco:gold_bars>);
craftingTable.removeByName("crafttweaker:autogenerated/craftingstation.crafting_station");
craftingTable.removeByName("crafttweaker:autogenerated/improved-stations.crafting_table_slab");
...
//craftingTable.addShaped("crafting-slab", <item:craftingstation:crafting_station>*2, [[<item:craftingstation:crafting_station>]]);
